...
Terms not explicitly defined in this specification are to be interpreted according
to the NIST Computer Security Resource Center Glossary (https://csrc.nist.gov/glossary)
