...
Terms not explicitly defined in this specification are to be interpreted
according to the NIST Computer Security Resource Center
Glossaryfootnote:[https://csrc.nist.gov/glossary]
...
This specification defines normative requirements. However, the specification does not mandate
...
This is not an exhaustive list, more examples can be found in
cite:[intel::zero-trust], cite:[microsoft::zero-trust], cite:[rvi::crypto],
cite:[rvi::server-platform], cite:[cc::pp0084b],
cite:[opentitan::device-lifecycle], cite:[nist::sp8320],
cite:[nist::sp800-193], cite:[rambus::rot], cite:[opentitan::security-model],
cite:[tcg::dice], cite:[ieee::logic-locking], cite:[acm::sw-fault-isolation],
cite:[acm:keystone], cite:[gilbert2011testing], cite:[ieee::rsm],
cite:[tches:aes-leakage], cite:[ieee:dual-rail], cite:[micro:spt],
cite:[arxiv:web-asm], cite:[rvi::debug], cite:[iso::IEC-17825:2024], and
cite:[samsung:knox].
