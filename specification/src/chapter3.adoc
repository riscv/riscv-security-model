...
*See section 1.2 (Privilege Levels) of the https://github.com/riscv/riscv-isa-manual/releases/latest[Privileged
ISA] specification.*
...
*See chapter 8 (Hypervisor Extension) of the https://github.com/riscv/riscv-isa-manual/releases/latest[Privileged
ISA] specification.*
...
Alternatively SPMP can be used instead of MMU to support static partitioning
...
*See section 3.6 (Physical Memory Attributes) of the https://github.com/riscv/riscv-isa-manual/releases/latest[Privileged
ISA] specification.*
...
*See section 3.7 (Physical Memory Protection) of the https://github.com/riscv/riscv-isa-manual/releases/latest[Privileged
ISA] specification.*
...
*See chapter 6 (PMP Enhancements for memory access and execution prevention in M-Mode) of the https://github.com/riscv/riscv-isa-manual/releases/latest[Privileged
ISA] specification.*

Smepmp extends PMP protection by allowing M-Mode to restrict its own access to memory allocated to lower privilege levels. This can be
...
NOTE: Dependent on the use case, it may be recommended or mandatory to use SPMP to protect S-Mode from lower privilege levels (with or without the H-extension). The MMU may be an additional or alternative mechanism.
...
*See sections 4.3 to 4.6 (Page-Based Virtual-Memory Systems) of the https://github.com/riscv/riscv-isa-manual/releases/latest[Privileged
ISA] specification.*
...
NOTE: Dependent on the use case, it may be recommended or mandatory to use MMU to protect S-Mode from lower privilege levels (with or without the H-extension). The SPMP and PMP may be an additional or alternative mechanism.
...
to a lower trust level supervisor domain. The trust levels/policies are specified by the
...
| SR_IOM_005
| Systems supporting MMU MUST also support IOMMU
...
*See Chapter 25 of https://github.com/riscv/riscv-isa-manual/releases/latest[Privileged ISA] specification.*
...
*See chapter 23 of https://github.com/riscv/riscv-isa-manual/releases/latest[Privileged
ISA] specification.*
...
*See Chapters 31 and 32 of https://github.com/riscv/riscv-isa-manual/releases/latest[Unprivileged
ISA] specification.*
...
| SR_CPT_002
| RISC-V systems SHALL support vector cryptographic ISA
extensions
