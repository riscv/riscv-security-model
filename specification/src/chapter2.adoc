...
* Allocation of execution resources among harts in a SMT system
...
Fence.t, Speculation barriers or similar future extensions, may at least partially mitigate against In-domain attacks (such as Spectre V1 , V4).
