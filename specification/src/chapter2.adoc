...
When a system in a security provisioning state doesn't restrict loading to only authorized software, other protection measures such as physical access protection, or device registration would be required.
